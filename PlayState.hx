...
class PlayState extends MusicBeatState
{
	...
	public dynamic function updateScoreText()
	{
		...
		if(!instakillOnMiss) tempScore = Language.getPhrase('score_text', 'Bambi Score: {1} | fahad Breaks: {2} | Dave Accuracy: {3}', [songScore, songMisses, str]);
		else tempScore = Language.getPhrase('score_text_instakill', 'Bambi Score: {1} | Dave Accuracy: {2}', [songScore, str]);
