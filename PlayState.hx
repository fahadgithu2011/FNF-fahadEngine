...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("vcr2.ttf"), 25, 0xFFF465, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("vcr.ttf"), 20, 0xFFF465, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		scoreTxt.scrollFactor.set();
		scoreTxt.borderSize = 1.25;
		scoreTxt.visible = !ClientPrefs.data.hideHud;
		noteGroup.add(scoreTxt);

		botplayTxt = new FlxText(400, healthBar.y - 90, FlxG.width - 800, Language.getPhrase("fahadgamingX2011 is currently on his computer").toUpperCase(), 25);
		botplayTxt.setFormat(Paths.font("vcrFPS.ttf"), 25, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	public dynamic function updateScoreText()
	{
		...
		if(!instakillOnMiss) tempScore = Language.getPhrase('score_text', 'Bambi Max Score: {1} | fahad Breaks: {2} | Dave Accuracy: {3}', [songScore, songMisses, str]);
		else tempScore = Language.getPhrase('score_text_instakill', 'Bambi Max Score: {1} | Dave Accuracy: {2}', [songScore, str]);
	...
	function startSong():Void
	{
		...
		// Song duration in a float, useful for the Song Name + Time feature
	...
	public function initLuaShader(name:String, ?glslVersion:Int = 120)
	{
		...
		for (folder in Mods.directoriesWithFile(Paths.getSharedPath(), '/assets/shared/shaders/'))
		{
